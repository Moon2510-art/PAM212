...
const styles = StyleSheet.create({
  ...
  editButton: {
    backgroundColor: "#4c84afff", 
  },
  button: {
    backgroundColor: "#007AFF",  // Ensure the button is visible and prominent
    padding: 16,
    borderRadius: 8,
    alignItems: "center",
    justifyContent: "center",
    marginBottom: 10, // Ensure some space around the button
  },
  buttonDisabled: {
    backgroundColor: "#cccccc", // Light grey for disabled state
  },
  ...
  buttonDisabledText: {
    color: "#999", // Darker grey for disabled text
  },
});
